    ...
    <div className='flex flex-row justify-around w-full'>
      <div className=' w-4/5 bg-gradient-to-br from-gray-100 to-white font-custom flex justify-around snap-y  snap-mandatory max-sm:flex-col max-md: flex-wrap' id='about'>
          ...
          <div  ref={map} className=' flex flex-col justify-center max-sm:text-center max-sm:w-full max-md:w-full max-lg:w-[600px] my-0'>
           ...
           <iframe className='max-sm:hidden max-md:hidden max-lg:hidden max-sm:w-full' width="600" height="400" id="gmap_canvas" src="https://maps.google.com/maps?q=%2017914%20E%20Hardy%20Rd,%20North%20Houston,%20TX,%20United%20States,%20Texas&t=k&z=15&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe>
          </div>
      </div>
    </div>
  )
